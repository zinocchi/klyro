        ...
        <div className="flex items-center justify-between pb-5 border-b border-monday-fog/40">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-semibold text-monday-ink">
                Sprint #42 — Launch Prep
              </h3>
            </div>
            <p className="text-xs text-monday-slate mt-0.5">
              3 lists · 12 cards active
            </p>
          </div>
          <div className="flex items-center gap-2">
          ...
          {MOCK_BOARD_TASKS.map((task) => (
            <motion.div
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-sm font-medium text-monday-ink">
                    {task.title}
                  </h4>
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`text-[11px] px-2 py-0.5 rounded-[4px] font-medium ${task.tagColor}`}>
                      {task.tag}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex items-center gap-3">
                {/* Status Pill */}
                <span
                  className={`text-xs px-3 py-1 rounded-[6px] font-medium ${task.statusColor}`}>
                  {task.status}
                </span>
      ...
      <motion.div
        ...
        <div>
          <div className="flex items-center gap-1.5">
            ...
            <p className="text-xs font-semibold text-monday-ink">
              Task Completed
            </p>
          </div>
